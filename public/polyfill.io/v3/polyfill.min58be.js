...
(function (self, undefined) {
  ...
  if (
    !(function () {
      if (
        "document" in self &&
        "documentElement" in self.document &&
        "style" in self.document.documentElement &&
        "scrollBehavior" in document.documentElement.style
      )
        return !0;
      if (
        Element.prototype.scrollTo &&
        Element.prototype.scrollTo.toString().indexOf("[native code]") > -1
      )
        return !1;
      try {
        var e = !1,
        ...
        return (
          o.setAttribute("style", "height: 1px; overflow: scroll;"),
          n.setAttribute("style", "height: 2px; overflow: scroll;"),
          o.appendChild(n),
          o.scrollTo(t),
          e
        );
    ...
    !(function (e, t) {
      ...
      !(function (e) {
        ...
        var n = function (e) {
          ...
          o = {
            ...
            get windowScroll() {
              return (
                this._windowScroll ||
                (this._windowScroll = window.scroll || window.scrollTo)
              );
            },
          },
          i = function (e) {
              ...
              i(function (t) {
                return (t.scrollBy = function n() {
                  if (1 === arguments.length) {
                    ...
                    return w(this, s(s({}, t), e));
                  }
                  var n = Number(arguments[0]),
                    r = Number(arguments[1]);
                  return w(this, { left: n, top: r });
                });
              });
          },
          p = function (e) {
          ...
          S = function (e, t) {
            return (
              ...
              (b(t.overflowY) || b(t.overflowX) || y(e))
            );
          },
          E = function (e) {
            var t = e.parentNode;
            return null !== t && t.nodeType === Node.DOCUMENT_FRAGMENT_NODE
              ? t.host
              : t;
          },
          T = function (e, t) {
            ...
            if (!1 !== e.isConnected) {
              for (
                ...
                if (
                  ...
                  (S(l, c) && o.push(l), "fixed" === c.position)
                )
                  break;
              }
              var a = window.visualViewport
                ...
                F = p(
                  m.writingMode ||
                    m.getPropertyValue("-webkit-writing-mode") ||
                    m.getPropertyValue("-ms-writing-mode")
                ),
                W = "rtl" !== m.direction,
                O = t(h(n, F, W), 2),
                X = O[0],
              ...
              o.forEach(function (e) {
                var t = e.getBoundingClientRect(),
                  ...
                  I =
                    "offsetWidth" in e
                      ? e.offsetWidth - e.clientWidth - b - y
                      : 0,
                  V =
                    "offsetHeight" in e
                      ? e.offsetHeight - e.clientHeight - g - S
                      : 0;
                if (r === e) {
                  switch (Y) {
                    case 2:
                  ...
                  var F = e.scrollLeft,
                    W = e.scrollTop;
                  (E = T(W + E, e.scrollHeight - o + V)),
                    (k = T(F + k, e.scrollWidth - i + I)),
                    (N += W - E),
                    (H += F - k);
                }
                P.push(function () {
                  return f(e, s(s({}, n), { top: E, left: k }));
                });
              }),
              ...
              i(function (n) {
                return (n.scrollTo = function r() {
                  if (1 === arguments.length) {
                    ...
                    var r = Number(n.left),
                      o = Number(n.top);
                    return f(this, s(s(s({}, n), { left: r, top: o }), e));
                  }
                  return t.apply(this, arguments);
                });
              });
          ...
          W = function (e) {
            ...
            if (e.left !== undefined || e.top !== undefined) {
              ...
              window.addEventListener("wheel", m, { passive: !0, once: !0 }),
          ...
          X = function (e) {
            ...
            return "smooth" !== e.behavior
              ? o.windowScroll.call(window, t, n)
              : W(s(s({}, e), { left: t, top: n }));
          },
          Y = function (e) {
            r() ||
              (window.scrollBy = function t() {
                if (1 === arguments.length) {
                  var t = arguments[0];
                  if (!u(t))
                    throw new TypeError(
            ...
            if (!r()) {
              ...
              window.scrollTo = function n() {
                if (1 === arguments.length) {
                  ...
                  var r = Number(n.left),
                    o = Number(n.top);
                  return W(s(s(s({}, n), { left: r, top: o }), e));
                }
                return t.apply(this, arguments);
              };
            }
        ...
        (e.elementScroll = f),
          (e.elementScrollBy = w),
          (e.elementScrollByPolyfill = m),
          (e.elementScrollIntoView = L),
          (e.elementScrollIntoViewPolyfill = j),
          (e.elementScrollPolyfill = d),
          (e.elementScrollTo = f),
          (e.elementScrollToPolyfill = F),
          (e.polyfill = H),
          (e.seamless = H),
          (e.windowScroll = W),
          (e.windowScrollBy = X),
          (e.windowScrollByPolyfill = Y),
          (e.windowScrollPolyfill = O),
          (e.windowScrollTo = W),
          (e.windowScrollToPolyfill = N),
