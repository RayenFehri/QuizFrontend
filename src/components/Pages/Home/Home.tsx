...
import { faBook, faCalendar, faClipboardList, faUserAlt ,faUsersCog} from "@fortawesome/free-solid-svg-icons";
import {
  faEye,
  faUserEdit,
  faUserTimes, 
          ...
          <div className="col-12 col-xxl-2">
            <div className="row align-items-center g-3 g-xxl-0 h-100 align-content-between">
              <div className="col-12 col-sm-6 col-md-3 col-lg-6 col-xl-3 col-xxl-12">
                ...
                <FontAwesomeIcon  className="fs-4 lh-1 text-primary-dark" icon={faBook}  />
              ...
              <div className="col-12 col-sm-6 col-md-3 col-lg-6 col-xl-3 col-xxl-12">
                <div className="d-flex align-items-center">
                <FontAwesomeIcon  className="fs-4 lh-1 text-success-dark" icon={faUserAlt}  />
              ...
              <div className="col-12 col-sm-6 col-md-3 col-lg-6 col-xl-3 col-xxl-12">
                <div className="d-flex align-items-center">
                <FontAwesomeIcon  className="fs-4 lh-1 text-danger-dark" icon={faClipboardList}  />
