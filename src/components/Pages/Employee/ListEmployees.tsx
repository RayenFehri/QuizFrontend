      ...
      .then((data: any[]) => {
        ...
        if (currentUser.authenticationData.user.user_metadata.role === 2) {
          ...
          usersData = data
            .filter(
              (user) =>
                user.user.user_metadata.role === 3 &&
                user.profile.groupe === userGroup
            ) // Filtrer les utilisateurs ayant le rôle 3 et le même groupe que l'utilisateur actuel
            .map((item) => ({
              id: item.user.id,
          ...
          currentUser.authenticationData.user.user_metadata.role === 1
        ) {
          ...
          >
            <div className="mb-4">
              <div className="row g-3">
                ...
                <div className="col-auto">
                  <a className="btn btn-primary px-5" href="/addEmployee">
                ...
                <table className="table table-sm fs-9 mb-0">
                  <thead>
                    <tr>
                      ...
                      <th
                        className="sort align-middle ps-11"
                        scope="col"
                        data-sort="last-order"
                        style={{ width: "15%" }}
                      >
                      ...
                      <th
                        className="sort align-middle ps-7 pe-0"
                        scope="col"
                        data-sort="last-order"
                        style={{ width: "5%" }}
                      >
                    ...
                    {filteredUsers.map((user, index) => (
                      ...
                      >
                        ...
                        <td className="align-middle white-space-nowrap assigness ps-5 py-4">
                          ...
                          <Link to={`/profileEmployee/${user.id}`}>
                            <FontAwesomeIcon
                              icon={faEye}
                              style={{ color: "#fb983c" }}
                            />
