                ...
                <table className="table table-sm fs-9 mb-0">
                  <thead>
                    <tr>
                      ...
                      <th className="align-middle pe-5" scope="col"  data-sort="last-order" style={{ width: "10%" }}> Manager</th>
                  ...
                  <tbody className="list" id="customers-table-body">
                    ...
                    <>
                      <Link to={`/editManager/${user.id}`} className="me-2">
                      ...
                      <a href="#" className="me-2" onClick={() => deleteUser(user.id)}>
                        <FontAwesomeIcon icon={faUserTimes} style={{ color: "#ee1127" }} />
                          ...
                          <Link to={`/profile Manager/${user.id}`} ><FontAwesomeIcon icon={faEye} style={{ color: "#fb983c" }} /></Link>
                        </td>
                      </tr>
                    ))}
                  </tbody>
