...
import { faHome , faListAlt , faPlusSquare, faQuestion , faUser ,faUserShield ,faUserPlus, faList, faLayerGroup, faMessage, faComments, faCommenting, faBuilding,faArrowRight,faArrowLeft} from '@fortawesome/free-solid-svg-icons';
